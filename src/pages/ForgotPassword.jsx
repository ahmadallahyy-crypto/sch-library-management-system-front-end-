    ...
    <div className="login-root">
      ...
      <div className="login-body">
        <div className="login-box">
          ...
          <p style={{ textAlign: 'center', color: 'var(--text-secondary)', marginBottom: 28, fontSize: '0.9rem' }}>
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            {sent && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 14px', background: 'var(--success-dim)', border: '1px solid #3ecf8e30', borderRadius: 'var(--radius-sm)', color: 'var(--success)', fontSize: '0.875rem' }}>
